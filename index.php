...
<div class="ltn__slider-area ltn__slider-3  section-bg-1">
    <div class="ltn__slide-one-active slick-slide-arrow-1 slick-slide-dots-1 arrow-white">
        ...
        <!-- ltn__slide-item -->
        <div class="ltn__slide-item ltn__slide-item-2 ltn__slide-item-3 text-color-white bg-image" data-bg="img/slider/12.jpg">
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="ltn__tab-menu ltn__tab-menu-2 ltn__tab-menu-top-right-- text-uppercase text-center">
                    <div class="nav">
                        <a class="active show" data-toggle="tab" href="#liton_tab_3_1">Fruits</a>
                ...
                <div class="tab-content">
                    ...
                    <?php
                    $fuits_query = "SELECT * FROM `products` p join `product_category` c on p.product_category = c.pto_cat_id where `product_category` = 6";
                    $execute = mysqli_query($conn, $fuits_query);
                    ...
                    <?php
                    $fuits_query = "SELECT * FROM `products` p join `product_category` c on p.product_category = c.pto_cat_id where `product_category` = 9";
                    $execute = mysqli_query($conn, $fuits_query);

                    ?>
                    <div class="tab-pane fade active show" id="liton_tab_3_3">
                        <div class="ltn__product-tab-content-inner">
                            <div class="row ltn__tab-product-slider-one-active slick-arrow-1">
                                <?php
                                while ($row = mysqli_fetch_assoc($execute)) {
